...
&НаСервере
Функция ПолучитьБаллоныДляБраковки()
...
Процедура УстановитьСписокВыбораБаллоновиВидРеквизитов()
	...
	БаллоныДляСертификации = ПолучитьБаллоныДляБраковки();
...
Функция ДатаТекущегоВыпуска(ТекущийВыпуск)
	возврат ТекущийВыпуск.Дата
КонецФункции // ()
...
Процедура ДокументВыпускПриИзменении(Элемент)
	// Вставить содержимое обработчика.
	//ЗаполнитьПереченьПартий();
	Объект.Дата= ДатаТекущегоВыпуска(Объект.ДокументВыпуск)+1;
	УстановитьСписокВыбораБаллоновиВидРеквизитов()
КонецПроцедуры
